...
- ``.IOStream.read_until_close`` now reports errors correctly when a stream closes uncleanly
  or exceeds a memory limit. Previously it would report a successful read of whatever was in the
  buffer.
