...
class SimpleHTTPClientTestMixin(object):
    ...
    def test_connect_timeout(self):
        ...
        class patching(object):
            ...
            # errno.ECONNRESET) will be handled by thd stack_context's
            # exception handler.
            #
            ...
            def __enter__(self):
                def _patched_handle_exception(instance, typ, value, tb):
                    ...
                    `ssl.SSL_ERROR_EOF` and `errno.ECONNRESET` may occur while
                    connection failed(mostly in `SSLIOStream._do_ssl_handshake`),
                    just ignore them. Other logic is the same as
                    ...
                    if isinstance(value, socket.error) \
                            and value.args[0] == errno.ECONNRESET:
                        return True
